			<?php
				...
				$siteVersion = $settings['site']['VERSION'];
			?>
					...
					<div class="container">
						<div class="row flex">
							...
							<div class='col'>
								...
								<br />
								<p class="_link"><a class="transition hover-color-primary" href='<?php echo get_site_url(); ?>/'>Paid Ads</a></p>
								<p class="_link"><a class="transition hover-color-primary" href='<?php echo get_site_url(); ?>/'>Social Media Content</a></p>
								<p class="_link"><a class="transition hover-color-primary" href='<?php echo get_site_url(); ?>/'>CRM & Automation</a></p>
								<p class="_link"><a class="transition hover-color-primary" href='<?php echo get_site_url(); ?>/'>Landing Pages & Funnels</a></p>
								<p class="_link"><a class="transition hover-color-primary" href='<?php echo get_site_url(); ?>/'>Reporting & Growth Optimisation</a></p>
							</div>
							<div class='col'>
							...
							<div class='col'>
								...
								<br />
								<p class="_link">Company registered name</p>
								<p class="_link"><a class="transition hover-color-primary" href='<?php echo get_site_url(); ?>/cookie-policy/'>Address goes in this area<br/>PIN Code, UK.</a></p>
							</div>
						</div>
					</div>
				</section>
