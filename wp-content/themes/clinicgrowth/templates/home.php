			...
			<section class="container">
				<div class="col-1-1 col flex center-center">
					<div class="col-1-1 flex center-left">
						<div class="col-1-2">
							<h1 class="font-bold t-a-l l-h-1-1 mar-0-a title color-secondary">We help private clinics <br/>attract 10–30 new <br/><span class="color-tertiary">high-value patients</span> <br/>every month.</h1>
							...
							<button class="background-secondary color-white hover-background-tertiary hover-color-white">Book Your Free Growth Audit</button>
						</div>
			...
			<div class="container">
				<div class="col-1-1 flex bottom-left top">
					...
					<div class="col-1-2 flex center-right right">
						<div class="i flex center-center b-r-100" style="height: 32px; width: 32px; background: #ecf7f5;">
					...
					<div class="col-3-5 right">
						<div class="all">
							<div class="one flex center-left">
								<div class="icon flex center-center b-r-100" style="background: #ecf7f5;">
						...
						<div class="reviews">
							<div class="one">
								...
								<div class="flex center-left" style="gap: 12px;">
									<div class="i flex center-center b-r-100">
